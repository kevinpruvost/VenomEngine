...
void Scene3(const vc::ScenePhase phase)
{
...
//            .emplace<vc::Model>("eye/eye.glb")
        ...
        case vc::ScenePhase::Activation: {
            ...
            camera.get_mut<vc::Transform3D>()->SetPosition(vcm::Vec3(-5.740f, 2.371f, -3.145f));
            camera.get_mut<vc::Transform3D>()->SetRotation({-0.061f, 11.050f, 0.0f});
